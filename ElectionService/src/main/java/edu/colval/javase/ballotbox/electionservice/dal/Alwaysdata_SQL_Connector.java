...
public class Alwaysdata_SQL_Connector implements I_SQL_Connector{
    ...
    public Connection connect() {
        ...
        datasource.setDatabaseName("boey_electionservice");
        Connection conn;
        // connection-string : jdbc:mariadb://mysql-boey.alwaysdata.net:3306/boey_voteservice?user=boey&password=ballotbox
        try {
